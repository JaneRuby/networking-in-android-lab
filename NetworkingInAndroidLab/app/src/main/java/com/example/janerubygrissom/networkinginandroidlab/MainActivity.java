package com.example.janerubygrissom.networkinginandroidlab;
                ...
                mList = new ArrayList<>();
                       ...
                       mAdapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1, android.R.id.text1, mList);
                        ...
                        mListView.setAdapter(mAdapter);
                               ...
                               mTea.setOnClickListener(new View.OnClickListener() {
                                       ...
                                       public void onClick(View view) {
                                                mList.clear();
                                                new DownloadTask().execute("http://api.walmartlabs.com/v1/search?query=tea&format=json&apiKey=67432j5cpvb3xacbx37tnk9f");
                                            }
                        ...
                        mCereal.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                       mList.clear();
                                        new DownloadTask().execute("http://api.walmartlabs.com/v1/search?query=cereal&format=json&apiKey=67432j5cpvb3xacbx37tnk9f");
                                    }
                            });
                        ...
                        mChocolate.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                       mList.clear();
                                        new DownloadTask().execute("http://api.walmartlabs.com/v1/search?query=chocolate&format=json&apiKey=67432j5cpvb3xacbx37tnk9f");
                                    }
                            });
